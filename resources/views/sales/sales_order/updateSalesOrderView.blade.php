        ...
        @if($salesorder->transactionStatus === 0) 
            ...
            <form id="ajaxInput" action="" method="POST">
                ...
                <div class=" row w-100 mh-100 justify-content-end pl-3">
                    <button type="button" class="btn btn-secondary updatePost btn-lg" id="createPO">Create Sales Order</button>
                </div>
            </form>
        @else 
            @if(count($salesorderlines) > 0)
                @foreach ($salesorderlines as $lines)
                    <div class="col-12 col-md-6 pb-5">
                        <div class="card" style="width: 100%;">
                            <div class="card-body pt-4">
                                <h4>Line Item {{$lines->modelType}}</h4>
                                <table>
                                    <tr>
                                        <th>Price</th>
                                        <td>: {{$lines->price}}</td>
                                    ...
                                    <tr>
                                        <th>Discount Meuble</th>
                                        <td>: {{$lines->discountMeuble}}</td>
                                    </tr>
                                    <tr>
                                        <th>Quantity</th>
