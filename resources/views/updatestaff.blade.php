...
@section('content')
  <div class="container">
    ...
    <div class="row justify-content-center">
        <div class="card p-5 mb-5" style="width: 75%;">
            <div class="card-body pt-4">
                ...
                <form class="pt-5">
                    <div class="form-group row">
                        <label for="customerName" class="col-sm-3 col-form-label">Old Password:</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="customerName" class="col-sm-3 col-form-label">New Password:</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="customerName" class="col-sm-3 col-form-label">Confirm Password:</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control">
                        </div>
                    </div>
                ...
                <div class="row justify-content-center">
                    <a name="" id="" class="btn mt-4 btn btn-warning mr-3" href="#" role="button">Save</a>
                    <a name="" id="" class="btn  mt-4 btn-light" href="#" role="button">Cancel</a>
                </div>
            </div>
        </div>
