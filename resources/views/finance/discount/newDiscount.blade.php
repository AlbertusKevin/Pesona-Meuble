                ...
                <div class="card" style="width: 100%;">
                    <div class="card-body pt-4">
                        <form action='/discount' method="POST">
                            ...
                            <div class="form-group row">
                                <label for="responsibleEmployee" class="col-sm-4 col-form-label">Responsible
                                    Employee</label>
                                <div class="col-sm-8">
                                    <input type="text" id='responsibleEmployee' name='responsibleEmployee'
                                        class="form-control" value='{{ $employee->name }}' disabled>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="percentDisc" class="col-sm-4 col-form-label">Discount (%)</label>
                                <div class="col-sm-8">
                                    <input type="number" id='percentDisc' name='percentDisc' class="form-control"
